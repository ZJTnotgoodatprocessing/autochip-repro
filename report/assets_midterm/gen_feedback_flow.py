...
plt.tight_layout()
plt.savefig("report/figures/fig_feedback_loop_flow.png", dpi=200, bbox_inches="tight",
            facecolor="white", edgecolor="none")
plt.savefig("report/figures/fig_feedback_loop_flow.svg", bbox_inches="tight",
            facecolor="white", edgecolor="none")
print("Saved: report/figures/fig_feedback_loop_flow.png/.svg")
