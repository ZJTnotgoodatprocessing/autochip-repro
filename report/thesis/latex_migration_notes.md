...
1. Ch4 全部三级标题（15个）合并为加粗段首标题，TOC条目降至7个
2. Ch5 全部三级标题（25个）合并为加粗段首标题，TOC条目降至10个
3. Ch6 §6.4 五个展望子节合并为一段自然段
4. 摘要、Ch1 润色，降低机械化表达
5. 新增表4.x（研究问题与实验设计对应）和表5.x（实验结论汇总）
6. 所有实验数据保持不变
7. v1/v2 保留为历史版本
